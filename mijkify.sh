...
apt-get install -y xserver-xorg xinit lightdm mesa-utils-extra mesa-vdpau-drivers libgl1-mesa-dri libgl1-mesa-glx build-essentials cmake qt5-qmake flex bison git subversion mercurial oracle-java8-installer google-chrome-stable
